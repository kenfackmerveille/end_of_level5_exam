...
@section("content")
	...
	@endif
		...
		<p>
			...
			<input type="text" name="name" value="{{ isset($post->name) ? $post->title : old('name') }}"  id="name" placeholder="Le nom du contact" >
		...
		<p>
			<label for="content" >numero</label><br/>
			<textarea name="content" id="content" lang="fr" rows="10" cols="50" placeholder="Le numero du contact" >{{ old('content') ? $post->content : old('content') }}</textarea>
